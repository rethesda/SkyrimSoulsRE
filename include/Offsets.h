...
namespace Offsets
{
	...
	{
		static constexpr REL::ID Reset(static_cast<std::uint64_t>(52086));  // + 0x3B
	}
	...
	namespace Menus
	{
		...
		namespace StatsMenu
		{
			...
			static constexpr REL::ID UpdateSkillList(static_cast<std::uint64_t>(52525));
			static constexpr REL::ID SetPlayerInfo(static_cast<std::uint64_t>(52536));
		}
